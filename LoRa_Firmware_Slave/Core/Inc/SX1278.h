...
typedef struct
{
	...
	/*!
 	*/
	uint8_t data[SX1278_MAX_PAYLOAD];
 ...
 * \param[in]  current      over_current_protection_*
...
void SX1278_getPacket(SX1278_t *module,SX1278_pack_t *packet);
