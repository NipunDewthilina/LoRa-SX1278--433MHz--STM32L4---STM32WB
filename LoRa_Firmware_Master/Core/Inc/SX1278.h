...
void SX1278_LoRaTxPacketRetry(SX1278_t *module, SX1278_pack_t *packet);

void SX1278_setPacketRetry(SX1278_t *module, uint8_t dest, uint8_t *massage, SX1278_pack_t *packet_sent);
#endif
